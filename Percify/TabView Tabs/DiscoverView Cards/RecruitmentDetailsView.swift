...
struct RecruitmentDetailsView: View {
    ...
    private var infoRow2: some View {
        HStack(spacing: 6) {
            ...
            Text("www.orientalland.co.jp").foregroundStyle(.secondary).font(.caption)
        }
        .padding(.horizontal)
    }
    ...
    private var infoRow3: some View {
        HStack(spacing: 6) {
            ...
            Text("1960年7月11日").foregroundStyle(.secondary).font(.caption)
        }
        .padding(.horizontal)
    }
    ...
    private var infoRow4: some View {
        HStack(spacing: 6) {
            ...
            Text("本社住所:").foregroundStyle(.secondary).fontWeight(.semibold).font(.caption)
                .padding(.leading, -0.5)
            Text("〒279-8511 千葉県浦安市美浜1丁目8番1号").foregroundStyle(.secondary).font(.caption)
        }
        .padding(.horizontal)
    }
    ...
    private var infoRow5: some View {
        HStack(spacing: 6) {
            ...
            Text("上場区分:").foregroundStyle(.secondary).fontWeight(.semibold).font(.caption)
                .padding(.leading, -1)
            Text("東京証券取引所 プライム市場（証券コード：4661）").foregroundStyle(.secondary).font(.caption)
        }
        .padding(.horizontal)
    }
    ...
    private var infoRow6: some View {
        HStack(spacing: 6) {
            ...
            Text("従業員数:").foregroundStyle(.secondary).fontWeight(.semibold).font(.caption)
                .padding(.leading, -2)
            Text("約5,800名").foregroundStyle(.secondary).font(.caption)
        }
        .padding(.horizontal)
    }
    ...
    private var infoRow7: some View {
        HStack(spacing: 6) {
            ...
            Text("事業内容:").foregroundStyle(.secondary).fontWeight(.semibold).font(.caption)
                .padding(.leading, 1)
            Text("東京ディズニーリゾートの開発・運営").foregroundStyle(.secondary).font(.caption)
        }
        .padding(.horizontal)
    }
    ...
    private var infoRow8: some View {
        HStack(spacing: 6) {
            ...
            Text("代表者名:").foregroundStyle(.secondary).fontWeight(.semibold).font(.caption)
                .padding(.leading, 1)
            Text("高橋 渉").foregroundStyle(.secondary).font(.caption)
        }
        .padding(.horizontal)
    }
    ...
    private var infoRow9: some View {
        HStack(spacing: 6) {
            ...
            Text("ホスピタリティ・ツーリズム").foregroundStyle(.secondary).font(.caption)
        }
        .padding(.horizontal)
    }
